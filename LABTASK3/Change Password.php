...
<h3 align="" style = "display:inline-block; width:150px;text-align:right;">CHANGE PASSWORD</h3><br />
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  

  <span style = "display:inline-block; width:150px;text-align:right;"><b>Current Password : </b></span>
  <input type="password" name="currentPass" value="<?php echo $currentPass;?>">
  <span class="error">* <?php echo $currentPassErr;?></span>
  <br><br>

  <span style = "display:inline-block; width:150px;text-align:right;"><b>New Password :</b></span> 
  <input type="password" name="newPass" value="<?php echo $newPass;?>">
  <span class="error">* <?php echo $newPassErr;?></span> 
   <br><br>

  <span style = "display:inline-block; width:150px;text-align:right;"><b><span class="error">Retype New Password : </span></b></span> 
  <input type="password" name="reNewPass" value="<?php echo $reNewPass;?>">
  <span class="error">* <?php echo $reNewPassErr;?></span> 
   
  
  <br><br>
  <span style = "display:inline-block; width:330px;text-align:right;"><input type="submit" name="submit" value="Submit"> </span> 
</form>
